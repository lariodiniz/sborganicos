# Generated by Django 2.1.2 on 2018-10-10 21:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Um nome curto que será usado para identificá-lo de forma única na plataforma', max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$'), 'informe um nome de usuário válidoEste valor dev conter apenas letras, numeros e os caracteres: @/./+/-/_ .', 'invalid')], verbose_name='Apelido / Usuário')),
